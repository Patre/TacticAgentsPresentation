...
\footlineextra{\cite{ww1, military_strategy, tactic,charleroi_battle}}
\end{frame}
...
\end{tikzpicture}
\footlineextra{\cite{fort_lupin,war,turtle_form,mongol_cavalery,sabotage}}
\end{frame}
...
\begin{frame}{Iruba}
\framesubtitle{Stratégies influant sur la réussite}
\begin{tikzpicture}[remember picture,overlay]
...
\framesubtitle{Stratégies influant sur la réussite}
\begin{tikzpicture}[remember picture,overlay]
	\node[inner sep=0pt,anchor=north west] at($(current page.north west)+(0.6cm,-2.5cm)$) {
		\includegraphics[scale=0.5]{../ressources/iruba_counter_attack}
	};
	\node[inner sep=0pt,anchor=north west] at($(current page.north west)+(0.5cm,-5.5cm)$) {
		\includegraphics[scale=0.5]{../ressources/iruba_force_concentration}
	};
	\node[inner sep=0pt,anchor=north east] at($(current page.north east)+(-1.0cm,-4.9cm)$) {
		\includegraphics[scale=0.5]{../ressources/iruba_hyper_mobility}
	};
	\node[inner sep=0pt,anchor=north east] at($(current page.north east)+(-0.1cm,-2.5cm)$) {
